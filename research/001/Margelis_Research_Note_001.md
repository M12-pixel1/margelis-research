...
Tomas Margelis\
Rūpestėlis Holding\
Research Note 001 · v1.0 · 16 September 2026
...
**I4 · External authorization.** Material authorization is evaluated outside the reasoning model. The model may propose. It does not self-authorize.
...
| --- | --- | --- |
| Expired mandate | Approval exists, but the grant expires before execution. | DENY or re-authorize. |
...
**Unauthorized Effect Rate.** Material effects that occurred outside authorized scope.

**False-Success Rate.** Runs reported as successful by the agent where external verification does not confirm the intended result.

**Replay Violation Rate.** Repeated material effects caused by retries or replays that should have been idempotent.

**Unverified Outcome Rate.** Runs that terminate without enough evidence to classify the external outcome.
...
The individual concepts evaluated in this note have existing prior art and related specifications. The works below are cited as such; their titles, authors, dates and links were checked against the source on 16 September 2026.
...
Publication occurs only once independent rerun is possible.

---

## About this document

**Series.** Margelis Research · Research Note 001 · Version 1.0 · 16 September 2026.
...
**Suggested citation.** Margelis, T. (2026). *From Mandate to Verified Outcome: An Evaluation Framework for Autonomous Agent Execution* (Margelis Research Note 001, Version 1.0). Rūpestėlis Holding.
